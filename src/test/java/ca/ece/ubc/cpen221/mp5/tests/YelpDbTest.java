...
public class YelpDbTest {
	...
	@Test
	public void test8() throws IOException, InvalidInputException, UserNotFoundException {
		YelpDb yelp = new YelpDb("data/users.json", "data/restaurants.json", "data/reviews.json");
	...
	@Test
	public void test13() throws IOException, InvalidInputException, UserNotFoundException, ReviewNotFoundException,
		...
		yelp.addUser("Me");
		yelp.addUserJSON("{\"url\": \"http://www.yelp.com/user_details?userid=ePerljemmmGHi-DAZ6ZELQ\", \"votes\": {\"funny\": 22, \"useful\": 28, \"cool\": 11}, \"review_count\": 68, \"type\": \"user\", \"user_id\": \"ePerljemmmGHi-DAZ6ZELQ\", \"name\": \"Chester R.\", \"average_stars\": 3.39705882352941}");
		yelp.addUserJSON("{\"url\": \"http://www.yelp.com/user_details?userid=HJctT_mE9kGJSdaMo5PD5w\", \"votes\": {\"funny\": 15, \"useful\": 44, \"cool\": 24}, \"review_count\": 25, \"type\": \"user\", \"user_id\": \"HJctT_mE9kGJSdaMo5PD5w\", \"name\": \"Phillip B.\", \"average_stars\": 3.56}");
		yelp.addRestaurant("My Restaurant");
		yelp.addRestaurantJSON("{\"open\": true, \"url\": \"http://www.yelp.com/biz/chipotle-mexican-grill-berkeley-4\", \"longitude\": -122.2590498, \"neighborhoods\": [\"Telegraph Ave\", \"UC Campus Area\"], \"business_id\": \"tzRNk1hqooBV3i-Q_yKP7g\", \"name\": \"Chipotle Mexican Grill\", \"categories\": [\"Fast Food\", \"Mexican\", \"Restaurants\"], \"state\": \"CA\", \"type\": \"business\", \"stars\": 3.0, \"city\": \"Berkeley\", \"full_address\": \"2311 Telegraph Ave\\nTelegraph Ave\\nBerkeley, CA 94704\", \"review_count\": 190, \"photo_url\": \"http://s3-media1.ak.yelpcdn.com/bphoto/xOTrsHOnDHi4flRHUp9DOA/ms.jpg\", \"schools\": [\"University of California at Berkeley\"], \"latitude\": 37.8683664, \"price\": 2}");
		yelp.addRestaurantJSON("{\"open\": true, \"url\": \"http://www.yelp.com/biz/the-sunny-side-caf%C3%A9-berkeley-2\", \"longitude\": -122.2658691, \"neighborhoods\": [\"Downtown Berkeley\", \"UC Campus Area\"], \"business_id\": \"PC-x4Om-XXGqFn0ludTykw\", \"name\": \"The Sunny Side Caf\\u00e9\", \"categories\": [\"Breakfast & Brunch\", \"Restaurants\"], \"state\": \"CA\", \"type\": \"business\", \"stars\": 3.5, \"city\": \"Berkeley\", \"full_address\": \"2136 Oxford St\\nDowntown Berkeley\\nBerkeley, CA 94704\", \"review_count\": 175, \"photo_url\": \"http://s3-media3.ak.yelpcdn.com/bphoto/NMgMutTLuSShNGQYt9NRJQ/ms.jpg\", \"schools\": [\"University of California at Berkeley\"], \"latitude\": 37.8701853, \"price\": 3}");
